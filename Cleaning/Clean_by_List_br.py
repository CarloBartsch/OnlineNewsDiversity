import re, csv, os
directory = r'C:\Users\admin\Documents\Dissertation\Diversity of News\Files\\br'
    ...
    if filename.endswith(".txt"):
        ...
        with open(filename_dir, 'r', encoding="utf8") as f:
            ...
            if datetime:
                ...
                with open('C:/Users/admin/Documents/Dissertation/Diversity of News/Helpfiles Skript/br/redundant_words.csv', newline='', encoding='latin') as e:
                ...
                with open('C:/Users/admin/Documents/Dissertation/Diversity of News/Files/br/Clean/'+filename,'w', encoding="utf-8") as e:
                    e.write(article)
            else:
                continue
    else:
