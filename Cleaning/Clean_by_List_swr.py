import re, csv, os
directory = r'C:\Users\admin\Documents\Dissertation\Diversity of News\Files\swr'
...
for filename in os.listdir(directory):
    ...
    if filename.endswith(".txt"):
        ...
        with open(filename_dir, 'r', encoding="utf8") as f:
            ...
            article = article[:size - 2500]

            with open('C:/Users/admin/Documents/Dissertation/Diversity of News/Helpfiles Skript/swr/redundant_words.csv', newline='', encoding='latin') as e:
                    redundantWords = csv.reader(e)
                    regex_before = re.compile('.+Suchen      Wetter    Verkehr')
            ...
            with open('C:/Users/admin/Documents/Dissertation/Diversity of News/Files/swr/Clean/'+filename,'w', encoding="utf-8") as e:
                e.write(article)
