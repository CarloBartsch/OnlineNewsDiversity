...
for filename in os.listdir(directory):
    ...
    if filename.endswith(".txt"):
        ...
        with open(filename_dir, 'r', encoding="utf8") as f:
            ...
            with open('C:/Users/admin/Documents/Dissertation/Diversity of News/Helpfiles Skript/ntv/redundant_words.csv', newline='', encoding='latin') as e:
            ...
            print(article)
            with open('C:/Users/admin/Documents/Dissertation/Diversity of News/Files/ntv/Clean/'+filename,'w', encoding="utf-8") as e:
                e.write(article)
    else:
        continue
