import re, csv, os
directory = r'C:\Users\admin\Documents\Dissertation\Diversity of News\Files\\zdf_nachrichten\Test'
...
for filename in os.listdir(directory):
    ...
    if filename.endswith(".txt"):
        ...
        with open(filename_dir, 'r', encoding="utf8") as f:
            ...
            with open('C:/Users/admin/Documents/Dissertation/Diversity of News/Helpfiles Skript/zdf_nachrichten/redundant_words_muster.csv', newline='') as e:
                redundantWords = csv.reader(e)
                regex_after = re.compile('Verfügbarkeit:.+')
                article = regex_after.sub("",article)
                regex_after = re.compile('Footer mit Inhaltsangabe.+')
                article = regex_after.sub("",article)
