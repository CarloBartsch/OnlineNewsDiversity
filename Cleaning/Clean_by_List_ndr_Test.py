    ...
    if filename.endswith(".txt"):
        ...
        with open(filename_dir, 'r', encoding="utf8") as f:
            ...
            if datetime:
                ...
                with open('C:/Users/admin/Documents/Dissertation/Diversity of News/Helpfiles Skript/ndr/redundant_words.csv', newline='') as e:
                ...
                article = " ".join(article.split())
                print(article)
                with open('C:/Users/admin/Documents/Dissertation/Diversity of News/Files/ndr/Clean/'+filename,'w', encoding="utf-8") as e:
                    e.write(article)
