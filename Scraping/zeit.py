...
#HTML
website = requests.get('https://www.zeit.de/news/index').text
html = BeautifulSoup(website,'lxml')
body = html.find('body')

try:
    data=[]
    with open('C:/Users/admin/Documents/Dissertation/Diversity of News/Helpfiles Skript/zeit/zeit_linklist.csv',encoding='utf-8') as f:
            reader = csv.reader(f, delimiter=',')
            for row in reader:
                    data.append(row)

except:
    with open('C:/Users/admin/Documents/Dissertation/Diversity of News/Helpfiles Skript/zeit/zeit_linklist.csv','w', newline='',encoding='utf-8') as f:
                ...
                for span in link.find_all("span",{"class":"zon-teaser-news__title"}):
                    ...
                    if href in href_column:
                        ...
                        try:
                            ...
                            with open(r'C:/Users/admin/Documents/Dissertation/Diversity of News/Helpfiles Skript/zeit/zeit_linklist.csv','a',newline='',encoding="utf-8") as f:
                                        writer = csv.writer(f)
                        ...
                        try:
                            ...
                            with open('C:/Users/admin/Documents/Dissertation/Diversity of News/Files/zeit/%s.txt' % name,'w', encoding="utf-8") as e:
                                e.write(article)
