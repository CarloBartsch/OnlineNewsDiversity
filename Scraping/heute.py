...
for element in ressorts:
        ...
        try:
            ...
            with open('C:/Users/admin/Documents/Dissertation/Diversity of News/Helpfiles Skript/zdf_nachrichten/zdf_linklist.csv','w', newline='',encoding='utf-8') as f:
        ...
        for link in body.find_all('a'):
                    ...
                    for div in link.find_all("span",{"class":"normal-space"}):
                        ...
                        #zu Liste hinzufügen
                            try:
                                with open(r'C:/Users/admin/Documents/Dissertation/Diversity of News/Helpfiles Skript/zdf_nachrichten/zdf_linklist.csv','a',newline='',encoding="utf-8") as f:
                                    writer = csv.writer(f)
                            ...
                            try:
                                ...
                                with open('C:/Users/admin/Documents/Dissertation/Diversity of News/Files/zdf_nachrichten/%s.txt' % name,'w', encoding="utf-8") as e:
                                    e.write(article)


                            except:
                                try:
                                    with open(r'C:/Users/admin/Documents/Dissertation/Diversity of News/Helpfiles Skript/zdf_nachrichten/zdf_error.csv','a',newline='',encoding="utf-8") as file_error:
                                        writer_error = csv.writer(file_error)
                                        writer_error.writerow(name,d2,href,'no')
                                except:
                                    with open('C:/Users/admin/Documents/Dissertation/Diversity of News/Helpfiles Skript/zdf_nachrichten/zdf_error.csv','w', newline='',encoding='utf-8') as file_error:
