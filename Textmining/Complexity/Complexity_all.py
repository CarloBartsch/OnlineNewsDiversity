...
with open('C:/Users/admin/Documents/Dissertation/Diversity of News/Textmining/Complexity/all_complexity.csv','w',encoding='utf8',errors='ignore', newline='') as word_file:
